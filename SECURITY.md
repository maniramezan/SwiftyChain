...
5. **No force unwraps** — optional values are never force-unwrapped. The one `CFTypeRef`-to-`SecKey` cast is guarded by a Core Foundation type-ID check before bridging.
